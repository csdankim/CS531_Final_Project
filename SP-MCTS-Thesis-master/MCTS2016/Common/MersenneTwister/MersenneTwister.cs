...
namespace Common
{
    public class MersenneTwister : System.Random
    {
        ...
        public MersenneTwister(uint seed) /* throws ArgumentOutOfRangeException */
        {
            if (seed == 0) {
                throw new ArgumentOutOfRangeException("seed", "must be different from 0");
            }
        ...
        public MersenneTwister()
            : this((uint)Environment.TickCount) /* a default initial seed is used   */
        {
